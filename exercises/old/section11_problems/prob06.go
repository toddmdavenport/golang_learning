// Create a slice to store the names of all of the states in the United States of
// America. Use make and append to do this. Goal: do not have the array that underlies
// the slice created more than once. What is the length of your slice? What is the
// capacity? Print out all of the values, along with their index position, without
// using the range clause. Here is a list of the 50 states:
